...
def main():
    ...
    try:
        ...
        print("     python -c \"from experiments.failure_modes import FailureModes;")
        print("                FailureModes.create_all_failure_demos()\"")
        print("\n  3. Analyze initialization sensitivity:")
        print("     python -c \"from experiments.initialization_sensitivity import InitializationSensitivity;")
        print("                InitializationSensitivity.analyze_nonconvex_function(n_starts=16)\"")
        print()
